...
- El robot trabaja con el protocolo 1 de la librería de Dynamixel.
...
- En la caarpeta Bogobot esta el archivo pricipal Bogobot.ino que llama todas las funciones, en el archivo functions.h viene le funcion movRobot, y demas protocolos, en el archivo IK.h vienen las funciones que hacen el calculo de la cinematica inversa y el archivo poses.h viene la pose offset o base para haecr el cero ralitivo o posicio cero del robot que es cuando esta erguido.
